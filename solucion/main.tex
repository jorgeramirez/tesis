...
una interfaz basada en reconomiento del habla para la aplicaci\'on escogida.


\input{solucion/aplicacion.tex}
\input{solucion/herramientas.tex}
\input{solucion/implementacion.tex}
