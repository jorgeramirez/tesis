...
La librer{\'\i}a \foreign{Pocketsphinx} es desarrollada en paralelo a Sphinx 4 en la Universidad
...
\foreign{Pocketsphinx} est\'a orientado a la optimizaci\'on del rendimiento y a la portabilidad a distintas
...
\begin{itemize}
	...
	instalaci\'on en plataformas m\'oviles como \foreign{Android}, iOS y el \foreign{Kindle} de 
	\foreign{Amazon}.
