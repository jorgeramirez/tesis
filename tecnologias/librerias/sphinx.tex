...
La librer{\'\i}a \foreign{Sphinx} 4 es un sistema de reconocimiento del habla de c\'odigo 
abierto desarrollado en
la Universidad \mbox{\foreign{Carnegie Mellon} \cite{Sphinx4}}. La misma est\'a implementada
completamente en el lenguaje de programaci\'on \foreign{Java}, y permite la utilizaci\'on de modelos 
de lenguaje,
...
\begin{itemize}
	...
	\item \emph{Licencia:} \foreign{Sphinx} 4 se distribuye bajo una licencia basada en la \gls{bsd},
	considerada
	...
	exista una versi\'on de la m\'aquina virtual de \foreign{Java} disponible.
