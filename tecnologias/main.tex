...
\begin{itemize}
    ...
    \item Librer{\'\i}as/\foreign{Framework}s: con junto de m\'etodos o funciones a los que se puede invocar.
...
\subsection{Librer\'ias/\foreign{Framework}s}
...
{Resumen de los criterios espec\'ificos de las Librer\'ias/\foreign{Framework}s. Primera parte.}
