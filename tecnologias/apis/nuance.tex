...
\foreign{Dragon Mobile} ofrece una \gls{api} para permitir
...
\begin{itemize}
	...
	\item \emph{Precio:} el uso de esta herramienta es gratuito para aplicaciones sin fines comerciales.
        Desde 0.007\$ a 0.009\$ por transacci\'on, dependiendo del tama\~no de la compra\footnote{\foreign{Nuance} var\'ia el precio
    ...
    el desarrollo en \mbox{plataformas m\'oviles como \foreign{Windows Phone}, \foreign{iOS} y \foreign{Android}.}
\end{itemize}