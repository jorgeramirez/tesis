...
comercial \foreign{Say-N-Play} \cite{SayNPlay}.
...
de comandos, para \foreign{chat} multijugador, o como medio de acceso a contenido 
...
\foreign{Dragon Gaming Speech Pack}, es una propuesta de \foreign{Nuance Inc.} que permite utilizar
...
\foreign{Dragon NaturallySpeaking}, de la misma compa\~n\'ia.

En cuanto a las consolas de videojuegos, cabe destacar la funcionalidad de control por voz de la consola
de \foreign{Microsoft}, \foreign{Xbox One}. Mediante un dispositivo perif\'erico denominado 
\foreign{Kinect}, la \foreign{Xbox One} permite acceder a un gran n\'umero de funcionalidades 
