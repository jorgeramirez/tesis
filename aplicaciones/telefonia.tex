...
\begin{itemize}
	...
	reconocimiento del habla. Como ejemplos pueden citarse el proyecto \foreign{Mercury} de \gls{att} \cite{Seneff2000Dialogue} 
...
Menci\'on especial merece el proyecto \foreign{Watson} de \gls{att} \cite{AttWatson}, el cual consiste en un motor de
