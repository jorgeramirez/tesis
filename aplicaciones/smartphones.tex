...
de reconocimiento. Una tecnolog\'ia que se encuentra en desarrollo es la \foreign{Web Speech \gls{api}} \cite{GoogleWebSpeechAPI}, 
que permite a los desarrolladores integrar reconocimiento y s\'intesis del habla a sus aplicaciones web utilizando
una \gls{api} que forma parte del navegador\footnote{La \foreign{Web Speech \gls{api}} es una propuesta de Google para integrar
