...
Entre los sistemas construidos en el marco de este programa se destaca \foreign{Harpy}, de la \gls{cmu},
capaz de reconocer el habla usando un vocabulario compuesto de 1011 palabras con una tasa de 
precisi\'on de \mbox{90\% \cite{Newell1978}.} \foreign{Harpy} fue el primer sistema en un utilizar una 
...
Otros sistemas desarrollados bajo el mismo programa son \foreign{Hearsay}(I y II) tambi\'en de \gls{cmu} y 
