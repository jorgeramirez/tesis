...
m\'{o}viles. En el 2008 fue lanzado \foreign{Google Voice Search} para iPhone permitiendo que usuarios
puedan hacer consultas al buscador de \foreign{Google} con la voz, actualmente el software forma parte de 
la aplicaci\'{o}n \foreign{Google Search} y se encuentra disponible para \foreign{Android} y otras 
plataformas \cite{GoogleSearch}.

\foreign{Siri}\footnote{Siri fue inicialmente desarrollada por \foreign{Siri Inc}. en el 2007, 
la empresa fue posteriormente adquirida por \foreign{Apple Inc}. en el 2010.}es una aplicaci\'{o}n 
de asistente personal inteligente lanzada como parte integral de iOS\footnote{iOS es un sistema 
operativo m\'{o}vil desarrollado por \foreign{Apple Inc}.}desde el 2011, la aplicaci\'{o}n utiliza
...
En lo que respecta a aplicaciones web, en el 2012 \foreign{Google} introdujo la \gls{api} 
