...
Sin embargo, la primera m\'{a}quina capaz de responder a un comando de voz fue \foreign{Radio Rex}, 
un juguete fabricado en \mbox{1920 \cite{AnusuyaSpeech2009}}.

\foreign{Radio Rex} era un peque\~{n}o perro de pl\'{a}stico sobre una base de hierro que se manten\'{i}a 
...
esta manera la corriente y causando que \foreign{Rex} saliese de su casa. 

El sonido de la ``e'' en \foreign{Rex} posee una componente correspondiente a 500 Hz, lo cual le 
