...
al plugin para \foreign{Gstreamer} \cite{GstreamerPocketsphinx} que se planeaba utilizar para integrar \foreign{TamTam Edit}
con el motor de reconocimiento.

Las primeras pruebas de \foreign{TamTam Listens} arrojaron tasas de error y tiempos de
respuesta muy elevados. Identificar al plugin para \foreign{Gstreamer} como la causa del problema
