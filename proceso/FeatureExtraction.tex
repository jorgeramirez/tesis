...
Aunque no existe una correspondencia directa entre las caracter{\'\i}sticas f{\'\i}sicas y las
...
Los picos del espectro del sonido se conocen como formantes \cite{Fant1960acoustic}. Distintos fonemas poseen 
...
\caption{Representaci\'on gr\'afica de un espectrograma, puede verse como una colecci\'on de espectros como la 
    figura~\ref{figure:formants} ubicados uno despu\'es de otro \cite{Jurafsky}.}
