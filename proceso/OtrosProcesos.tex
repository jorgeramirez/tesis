...
La \gls{dtw} es una t\'ecnica t\'ipica del enfoque
...
\caption{A la izquierda se pueden observar dos secuencias similiares pero desfasadas. Para alinear estas secuencias
    se construye la matriz $C$ y se busca la trayectoria de deformaci\'on. Gr\'afico modificado de \cite{ThanawinDTW}}
\label{figure:dtw}
\end{figure}

\gls{dtw} ha probado ser un m\'etodo eficiente para el reconocimiento de palabras pronunciadas pausadamente \cite{MyersALevel1981} y ha sido
...
y viene desarroll\'andose como m\'etodo alternativo desde entonces. La \gls{rna} es capaz de resolver tareas de reconocimiento
m\'as complicadas, pero no escala tan bien como el \gls{hmm}  cuando se trata de grandes vocabularios \cite{VimalaReview2012}.
