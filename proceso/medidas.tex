...
En \cite{VimalaReview2012} se muestra una comparaci\'on de varias aplicaciones de reconocimiento del habla 
...
\foreign{corpus} a partir del cual fueron entrenados. El \foreign{corpus} se divide en un conjunto
...
La perplejidad es una m\'etrica que indica que tan adecuadamente puede representarse el \foreign{corpus} de prueba utilizando el modelo de lenguaje \cite{RosenfeldStatistical1997}. 
...
siendo $M$ el n\'umero total de palabras en el \foreign{corpus} de prueba y $p(x^{(i)})$ la 
...
perplejidad de 79,4 para la porci\'on del \foreign{Wall Street Journal Corpus} conocida 
como \foreign{Peen Treebank}.