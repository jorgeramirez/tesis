...
\begin{enumerate}
	...
	\item Una la funci\'on que determina la transici\'on entre urnas.
...
Con la ayuda de este ejemplo, podemos definir formalmente un HMM. Un modelo oculto de Markov es un 
